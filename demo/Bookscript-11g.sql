/* 2010-08-18 mcr Create Just Lee Books Database for Casteel 11g Textbook examples. employees2 table was re-named to employees2 to avoid conflict with HR database employees2 table.  */
...
CREATE TABLE employees2 (
 ...
 BONUS               NUMBER(6,2),
 MGR                 NUMBER(4),
 CONSTRAINT employees2_empno_PK PRIMARY KEY (EMPNO));
INSERT INTO employees2 VALUES (7839,'KING','BEN', 'GTECH2','17-NOV-91',10,6000,3000,NULL);
INSERT INTO employees2 VALUES (8888,'JONES','LARRY','MTech2','17-NOV-98',10,4200,1200,7839);
INSERT INTO employees2 VALUES (7344,'SMITH','SAM','GTech1','17-NOV-95',20,4900,1500,7839);
INSERT INTO employees2 VALUES (7355,'POTTS','JIM','GTech1','17-NOV-95',20,4900,1900,7839);
INSERT INTO employees2 VALUES (8844,'STUART','SUE','MTech1','17-NOV-98',10,3700,NULL,8888);
