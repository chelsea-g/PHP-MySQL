...
<rss version="2.0">
  ...
  <channel>
    ...
    <link>https://php-webdev-with-mysql-cgreger.c9users.io/labs/week14/aliens/newsfeed.php</link>
...
<?php
  ...
  while ($row = mysqli_fetch_array($data)) { 
    ...
    echo '  <link>https://php-webdev-with-mysql-cgreger.c9users.io/labs/week14/aliens/index.php?abduction_id=' . $row['abduction_id'] . '</link>';
