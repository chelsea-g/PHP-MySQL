...
<?php
    ...
    //Output the scores to the homepage using a table
    while ($row = mysqli_fetch_array($data)) { 
        ...
        echo '<tr><td class="scoreinfo"><br /><br />';
        echo '<span class="score">' . $row['score'] . '</span><br />';
        echo '<strong>Name:</strong> ' . $row['name'] . '<br />';
        echo '<strong>Date:</strong> ' . $row['date'] . '</td></tr>';

        //is_file() used to check if the screenshot image exists
        //filesize() checks to see that the screen shot image file isn't an empty file
