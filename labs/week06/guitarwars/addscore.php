...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        //Database connectin needed to use mysqli_real_escape_string
        ...
        if (!empty($name) && is_numeric($score) && !empty($screenshot)) {
            ...
            echo '<p class="error">Please make sure all information is entered and your score only includes' .
                    ' numbers to add your high score. </p>';
