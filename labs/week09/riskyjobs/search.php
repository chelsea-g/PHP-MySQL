...
<?php
    ...
    //This functin builds a search query from the search keywords and sort setting
    function build_query($user_search, $sort) {
        ...
        //Get rid of spaces from the search_words
        if (count($search_words) > 0) {
            ...
            foreach($search_words as $word) {
                ...
                if (!empty($word)) {
                    ...
                    //Using [] in this way acts as array_push()
        ...
        //Add each searched word to the where clause
        ...
        //Add the keyword WHERE to the search query
    ...
    //Grab sort setting and search keywords from URL GET
    $sort = $_GET['sort'];
